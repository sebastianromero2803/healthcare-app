...
export default function ConversationTranscript({
  ...
  const playTranslatedText = async (text: string, index: number) => {
    ...
    try {
      // Get the snippet and determine the correct target language voice
      const snippet = conversation[index]
      const targetLanguage = snippet.source_role === ROLES.DOCTOR ? patientLanguage : doctorLanguage
